    ...
    <div className="player" >
      <div className="player__controllers">
        <Link to={`/song/${randomIdFromArtist}`}>
          <FontAwesomeIcon className='player__icon' icon={faBackwardStep} onClick={() => setCurrentTime(formatTime(0))} />
        </Link>
        ...
        <Link to={`/song/${randomId2FromArtist}`}>
          <FontAwesomeIcon className='player__icon' icon={faForwardStep} onClick={() => setCurrentTime(formatTime(0))} />
        </Link>
      </div>
